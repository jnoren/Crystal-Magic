...
//  Copyright (c) 2013 Jack Noren. All rights reserved.
//
...
-(void) touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    self.predictionLabel.text = 0;
    self.predictionLabel.alpha = 0.0f;
}

-(void) touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    [self makePrediction];
    //.predictionLabel.text = [self.crystalBall randomPrediction];
}
